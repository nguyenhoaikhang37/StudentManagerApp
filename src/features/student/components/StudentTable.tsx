...
import { capitalizeString, getMarkColor } from 'utils(nhung ham share chung)';
          ...
          <TableBody>
            {studentList.map((student) => (
              <TableRow key={student.id}>
                <TableCell width="300">{student.id}</TableCell>
                <TableCell>{student.name}</TableCell>
                <TableCell>{capitalizeString(student.gender)}</TableCell>
                <TableCell>
                  <Box style={{ fontWeight: 'bold', color: getMarkColor(student.mark) }}>
                    {student.mark}
                  </Box>
                </TableCell>
